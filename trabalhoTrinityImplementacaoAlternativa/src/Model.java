...
public class Model {
    ...
    public String[] deletaN(String[] dadosArray){
        String[] newArray = new String[dadosArray.length - 5000];
        System.arraycopy(dadosArray, 5000, newArray, 0, dadosArray.length - 5000);
        return newArray;
    }
}
